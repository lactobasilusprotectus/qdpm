...
class sfWidgetFormSelectRadio extends sfWidgetFormChoiceBase
{
  ...
  public function formatter($widget, $inputs)
  {
    ...
    {
      $rows[] = $this->renderContentTag('div', '<label style="display:inline"><table cellpadding="0" cellspacing="0"><tr><td valign="top">' . $input['input']  . '</td><td style="padding: 0px 0 0 2px;">' . $input['label']. '</td></tr></table></label>');
    }
