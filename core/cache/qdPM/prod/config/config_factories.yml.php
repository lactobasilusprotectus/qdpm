...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\inetpub\\wwwroot\\qdpm\\core\\log/qdPM_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\inetpub\\wwwroot\\qdpm\\core\\cache\\qdPM\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\inetpub\\wwwroot\\qdpm\\core\\apps\\qdPM/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('qdPM8'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\inetpub\\wwwroot\\qdpm\\core\\cache\\qdPM\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\inetpub\\wwwroot\\qdpm\\core\\apps\\qdPM/template',
)));
